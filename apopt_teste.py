...
#         shunt[109]= sep.Var(qshunt[109],-0.2,0)
        ...
        shunt[4]= sep.Var(qshunt[4]*100,0,0.40*100,integer=True)
        shunt[33]= sep.Var(qshunt[33]*100,-0.14*100,0,integer=True)
        shunt[36]= sep.Var(qshunt[36]*100,0,0.25*100,integer=True)
        shunt[43]= sep.Var(qshunt[43]*100,-0.1*100,0,integer=True)
        shunt[44]= sep.Var(qshunt[44]*100,-0.1*100,0,integer=True)
        shunt[45]= sep.Var(qshunt[45]*100,-0.1*100,0,integer=True)
        shunt[47]= sep.Var(qshunt[47]*100,-0.15*100,0,integer=True)
        shunt[73]= sep.Var(qshunt[73]*100,-0.12*100,0,integer=True)
        shunt[78]= sep.Var(qshunt[78]*100,-0.2*100,0,integer=True)
        shunt[81]= sep.Var(qshunt[81]*100,-0.2*100,0,integer=True)
        shunt[82]= sep.Var(qshunt[82]*100,-0.1*100,0,integer=True)
        shunt[104]= sep.Var(qshunt[104]*100,-0.2*100,0,integer=True)
        shunt[106]= sep.Var(qshunt[106]*100,-0.06*100,0,integer=True)
        shunt[109]= sep.Var(qshunt[109]*100,-0.06*100,0,integer=True)
...
#                 else: taps.append(sep.Var(valor*10,0.95,1.05))
...
#         sep.Obj(voltage_dev(tensoes)) # desvio
        ...
        sep.solver_options =['minlp_maximum_iterations 50000',
...
#                             'bound_frac 1e-4']  
        ...
        shunt[8]= sep.Var(qshunt[8]*100,-0.05*100,0,integer=True)
        ...
        for valor in tap:
            ...
            if valor !=1:
                ...
                taps.append(sep.Var(valor*100,0.95*100,1.05*100,integer=True))
#                 taps.append(sep.sos1([0.88,0.8875,0.895,0.9025,0.91,0.9175,0.925,0.9325,0.94,0.9475,0.955,0.9625,0.97,0.9775,0.985,0.9925,1.0,1.0075,1.015,1.0225,1.03,1.0375,1.045,1.0525,1.06,1.0675,1.075,1.0825,1.09,1.0975,1.105,1.1125,1.12]))
...
#                             'bound_frac 1e-6']  
        ...
        sep.solver_options =['minlp_maximum_iterations 100000',                            'nlp_maximum_iterations 10000',
                            ]
        ...
        shunt[9]= sep.Var(qshunt[9]*100,-0.05*100,0,integer=True)
        shunt[23]= sep.Var(qshunt[23]*100,-0.05*100,0,integer=True)
...
#                             'bound_frac 1e-6']  
        ...
        sep.solver_options =['minlp_maximum_iterations 50000',                            'nlp_maximum_iterations 10000',
                            ]
